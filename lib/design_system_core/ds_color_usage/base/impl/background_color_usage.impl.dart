...
class _DSBackgroundColorUsage extends DSColorUsage {
  ...
  DSColor get secondary => colors.gray.shade100;
  DSColor get disable => colors.gray.shade100;
  DSColor get brandPrimary => colors.brand.shade500;
  DSColor get brandSecondary => colors.brand.shade100;
  DSColor get errorPrimary => colors.orange.shade500;
  DSColor get errorSecondary => colors.orange.shade100;
  DSColor get successPrimary => colors.green.shade500;
  DSColor get successSecondary => colors.green.shade100;
  DSColor get waitingPrimary => colors.blue.shade500;
  DSColor get waitingSecondary => colors.blue.shade100;
