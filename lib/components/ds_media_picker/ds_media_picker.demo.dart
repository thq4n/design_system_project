...
import 'ds_media_picker.dart';

class DSMediaPickerDemo extends StatefulWidget {
  const DSMediaPickerDemo({super.key});

  @override
  State<DSMediaPickerDemo> createState() => _DSMediaPickerDemoState();
}

class _DSMediaPickerDemoState extends State<DSMediaPickerDemo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('DS Media Picker Demo'),
        actions: [
          IconButton(
        ...
        child: Column(
          ...
          children: [
            ...
            DSMediaPicker(
              ...
              maxMedia: 5,
              crossAxisCount: 3,
              saveLocalFolder: 'media_picker_demo',
              onMediaPicked: (media) {
            ...
            DSMediaPicker(
              ...
              maxMedia: 3,
              crossAxisCount: 4,
              saveLocalFolder: 'media_picker_demo_both',
              autoUpload: false,
            ),
            const SizedBox(height: 24),
            const Text(
            ...
            DSMediaPicker(
              ...
              maxMedia: 2,
              crossAxisCount: 2,
              saveLocalFolder: 'media_picker_demo_gallery',
            ),
          ],
        ),
      ),
